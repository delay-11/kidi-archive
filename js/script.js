...
const keyboardCompatDB = {
  ...
  /* ---------- LEOPOLD(레오폴드) ---------- */
  'LEOPOLD FC750': {brand:'LEOPOLD(레오폴드)', verdict:'ok', reason:OK_REASON, alias:['레오폴드 fc750']},
  'LEOPOLD FC900': {brand:'LEOPOLD(레오폴드)', verdict:'ok', reason:OK_REASON, alias:['레오폴드 fc900']},
  'LEOPOLD FC980': {brand:'LEOPOLD(레오폴드)', verdict:'ok', reason:OK_REASON, alias:['레오폴드 fc980']},
  'LEOPOLD FC630': {brand:'LEOPOLD(레오폴드)', verdict:'ok', reason:OK_REASON, alias:['레오폴드 fc630']},
  'LEOPOLD FC730': {brand:'LEOPOLD(레오폴드)', verdict:'ok', reason:OK_REASON, alias:['레오폴드 fc730']},
  'LEOPOLD FC650': {brand:'LEOPOLD(레오폴드)', verdict:'ok', reason:OK_REASON, alias:['레오폴드 fc650']},
  'LEOPOLD FC660': {brand:'LEOPOLD(레오폴드)', verdict:'ok', reason:OK_REASON, alias:['레오폴드 fc660']},
  'LEOPOLD R3TL': {brand:'LEOPOLD(레오폴드)', verdict:'warn', reason:'정전용량 무접점(토프레) 방식이라 스위치 모양이 달라요. 전용 키캡인지 확인하세요.', alias:['레오폴드 r3tl']},
  'LEOPOLD R4 TKL': {brand:'LEOPOLD(레오폴드)', verdict:'warn', reason:'정전용량 무접점(토프레) 방식이라 스위치 모양이 달라요. 전용 키캡인지 확인하세요.', alias:['레오폴드 r4 tkl']},
  'LEOPOLD R4 BT': {brand:'LEOPOLD(레오폴드)', verdict:'warn', reason:'정전용량 무접점(토프레) 방식이라 스위치 모양이 달라요. 전용 키캡인지 확인하세요.', alias:['레오폴드 r4 bt']},
  'LEOPOLD R3TLM': {brand:'LEOPOLD(레오폴드)', verdict:'warn', reason:'정전용량 무접점(토프레) 방식이라 스위치 모양이 달라요. 전용 키캡인지 확인하세요.', alias:['레오폴드 r3tlm']},
  'LEOPOLD R3TLS': {brand:'LEOPOLD(레오폴드)', verdict:'warn', reason:'정전용량 무접점(토프레) 방식이라 스위치 모양이 달라요. 전용 키캡인지 확인하세요.', alias:['레오폴드 r3tls']},
  ...
  /* ---------- ABKO(앱코) ---------- */
  'ABKO A108K': {brand:'ABKO(앱코)', verdict:'ok', reason:OK_REASON, alias:['앱코 a108k']},
  'ABKO K561': {brand:'ABKO(앱코)', verdict:'ok', reason:OK_REASON, alias:['앱코 k561']},
  'ABKO AS104': {brand:'ABKO(앱코)', verdict:'ok', reason:OK_REASON, alias:['앱코 as104']},
  'ABKO ACH105': {brand:'ABKO(앱코)', verdict:'ok', reason:OK_REASON, alias:['앱코 ach105']},
  'ABKO KN30BT': {brand:'ABKO(앱코)', verdict:'ok', reason:OK_REASON, alias:['앱코 kn30bt']},
  'ABKO ACH108': {brand:'ABKO(앱코)', verdict:'ok', reason:OK_REASON, alias:['앱코 ach108']},
  'ABKO AF108PRO': {brand:'ABKO(앱코)', verdict:'ok', reason:OK_REASON, alias:['앱코 af108pro']},
  'ABKO AO98': {brand:'ABKO(앱코)', verdict:'ok', reason:OK_REASON, alias:['앱코 ao98']},
  'ABKO APK82BT': {brand:'ABKO(앱코)', verdict:'ok', reason:OK_REASON, alias:['앱코 apk82bt']},
  'ABKO AN94BT': {brand:'ABKO(앱코)', verdict:'ok', reason:OK_REASON, alias:['앱코 an94bt']},
  'ABKO AR108G': {brand:'ABKO(앱코)', verdict:'ok', reason:OK_REASON, alias:['앱코 ar108g']},
  'ABKO AK87': {brand:'ABKO(앱코)', verdict:'ok', reason:OK_REASON, alias:['앱코 ak87']},
  'ABKO K562': {brand:'ABKO(앱코)', verdict:'ok', reason:OK_REASON, alias:['앱코 k562']},
  'ABKO KN35BT': {brand:'ABKO(앱코)', verdict:'ok', reason:OK_REASON, alias:['앱코 kn35bt']},
  'ABKO KN03BT': {brand:'ABKO(앱코)', verdict:'ok', reason:OK_REASON, alias:['앱코 kn03bt']},
  'ABKO LKN99': {brand:'ABKO(앱코)', verdict:'ok', reason:OK_REASON, alias:['앱코 lkn99']},
  'ABKO AK84': {brand:'ABKO(앱코)', verdict:'ok', reason:OK_REASON, alias:['앱코 ak84']},
  'ABKO AK94': {brand:'ABKO(앱코)', verdict:'ok', reason:OK_REASON, alias:['앱코 ak94']},
  'ABKO AS87': {brand:'ABKO(앱코)', verdict:'ok', reason:OK_REASON, alias:['앱코 as87']},
  'ABKO LKN84': {brand:'ABKO(앱코)', verdict:'ok', reason:OK_REASON, alias:['앱코 lkn84']},
  'ABKO AG75W': {brand:'ABKO(앱코)', verdict:'ok', reason:OK_REASON, alias:['앱코 ag75w']},
  'ABKO K660': {brand:'ABKO(앱코)', verdict:'warn', reason:'기계식이지만 모델별로 조금씩 달라 구매 전 확인이 필요해요.', alias:['앱코 k660']},
  'ABKO MK108': {brand:'ABKO(앱코)', verdict:'no', reason:'멤브레인 방식이라 스위치 모양이 달라요.', alias:['앱코 mk108']},
  'ABKO MK98': {brand:'ABKO(앱코)', verdict:'no', reason:'멤브레인 방식이라 스위치 모양이 달라요.', alias:['앱코 mk98']},
  'ABKO AK10': {brand:'ABKO(앱코)', verdict:'no', reason:'멤브레인 방식이라 스위치 모양이 달라요.', alias:['앱코 ak10']},
  'ABKO WKM40': {brand:'ABKO(앱코)', verdict:'no', reason:'멤브레인 방식이라 스위치 모양이 달라요.', alias:['앱코 wkm40']},
  'ABKO AMK108': {brand:'ABKO(앱코)', verdict:'no', reason:'멤브레인 방식이라 스위치 모양이 달라요.', alias:['앱코 amk108']},
  'ABKO ACM105': {brand:'ABKO(앱코)', verdict:'no', reason:'멤브레인 방식이라 스위치 모양이 달라요.', alias:['앱코 acm105']},
  'ABKO MK108W': {brand:'ABKO(앱코)', verdict:'no', reason:'멤브레인 방식이라 스위치 모양이 달라요.', alias:['앱코 mk108w']},
  'ABKO NTP84': {brand:'ABKO(앱코)', verdict:'no', reason:LP_REASON, alias:['앱코 ntp84']},
  'ABKO K150': {brand:'ABKO(앱코)', verdict:'no', reason:'멤브레인 방식이라 스위치 모양이 달라요.', alias:['앱코 k150']},
  'ABKO MK87': {brand:'ABKO(앱코)', verdict:'no', reason:'멤브레인 방식이라 스위치 모양이 달라요.', alias:['앱코 mk87']},
  'ABKO KM400': {brand:'ABKO(앱코)', verdict:'no', reason:'멤브레인 방식이라 스위치 모양이 달라요.', alias:['앱코 km400']},
  ...
  'GEEKSTAR 파운데이션': {brand:'GEEKSTAR(긱스타)', verdict:'no', reason:'멤브레인 방식이라 스위치 모양이 달라요.', alias:['긱스타 파운데이션']},
  ...
  'GEEKSTAR GK01': {brand:'GEEKSTAR(긱스타)', verdict:'no', reason:'멤브레인 방식이라 스위치 모양이 달라요.', alias:['긱스타 gk01']},
